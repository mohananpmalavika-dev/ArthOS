...
import customerAssessmentHandler from '../api_src/customer-assessment.js';
...
const routeDefinitions = [
  ...
  { match: (pathname) => pathname === '/api/customer-assessment/submit', handler: customerAssessmentHandler },
