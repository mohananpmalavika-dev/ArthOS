...
export const v2BehaviourQuestions = [
  // ── GATE QUESTIONS (must come first) ──
  {
    ...
    context: "This is the single biggest predictor of financial behaviour — understanding your emotional relationship reveals why you spend the way you do.",
  ...
  },
  {
    ...
    context: "Social pressure is a hidden expense — knowing your susceptibility helps us protect you from lifestyle inflation.",
    expressPriority: "critical",
    options: [
  ...
  },
  {
    ...
    context: "This tension reveals whether you're set up for long-term wealth or trapped in short-term thinking.",
    expressPriority: "critical",
    options: [
  ...
  },
  {
    ...
    context: "A waiting rule is the single most effective tool against impulse spending — even partial adoption helps.",
  ...
  },
  {
    ...
    context: "Planned buying prevents the 'just one more thing' spiral that quietly drains thousands.",
    expressPriority: "high",
    options: [
      { value: "never", label: "Never" },
  ...
  },
  {
    ...
    context: "Knowing your future cash position stops today's small purchase from becoming tomorrow's shortfall.",
    expressPriority: "high",
    options: [
      { value: "no", label: "No" },
      { value: "sometimes", label: "Sometimes" },
  ...
  // ── FOLLOW-UP QUESTIONS (skipped by gate answers above) ──
  {
    ...
    context: "Subscriptions are silent cash leaks — monthly reviews cut waste without changing your lifestyle.",
  ...
  },
  {
    ...
    context: "Unplanned purchases reveal the gap between your budget and reality — closing it is where real savings live.",
    expressPriority: "normal",
    options: [
  ...
  },
  {
    ...
    context: "The regret gap is a measure of misalignment between your values and your spending. Small, not zero.",
    expressPriority: "normal",
    options: [
  ...
  },
  {
    ...
    context: "Boredom spending is one of the most common — and most preventable — drains on disposable income.",
    expressPriority: "normal",
    options: [
  ...
  },
  {
    ...
    context: "Stress spending is a coping mechanism — recognising it is the first step to breaking the cycle.",
    expressPriority: "normal",
    options: [
      { value: "very_likely", label: "Very likely" },
      { value: "sometimes", label: "Sometimes" },
  ...
  },
  {
    ...
    context: "Avoidance amplifies financial stress — checking your balance breaks the anxiety-feedback loop.",
    expressPriority: "normal",
    options: [
...
export const v2AwarenessQuestions = [
  // ── GATE QUESTIONS (must come first) ──
  {
    ...
    context: "Comparison spending is the most expensive emotion — knowing its role helps you spend on purpose, not on impulse.",
    expressPriority: "critical",
    options: [
  ...
  },
  {
    ...
    context: "Tracking is the single highest-leverage habit — it alone reduces overspending by 20-30%.",
    expressPriority: "critical",
    options: [
  ...
  },
  {
    ...
    context: "Debt you don't know about grows faster than debt you track — awareness is the first step to repayment.",
    expressPriority: "high",
    options: [
  ...
  },
  {
    ...
    context: "If you don't know the number, you can't control it. This is the foundation of every budget.",
    expressPriority: "high",
    options: [
  ...
  // ── FOLLOW-UP QUESTIONS (skipped by gate answers above) ──
  {
    ...
    context: "Your savings rate is the single metric that correlates most with long-term financial independence.",
    expressPriority: "normal",
    options: [
  ...
  },
  {
    ...
    context: "Monthly reviews keep your budget alive — without them, plans drift and spending creeps up.",
    expressPriority: "normal",
    options: [
      { value: "never", label: "Never" },
  ...
  },
  {
    ...
    context: "Identifying top 3 expenses gives you 80% of the insight with 20% of the effort — Pareto's principle for your money.",
    expressPriority: "normal",
    options: [
      { value: "no", label: "No" },
...
export const v2HabitsQuestions = [
  // ── GATE QUESTIONS ──
  {
    ...
    context: "Follow-through is the bridge between intention and financial health — this alone predicts progress more than any plan.",
    expressPriority: "critical",
    options: [
      { value: "rarely", label: "Rarely" },
      { value: "sometimes", label: "Sometimes" },
  ...
  // ── FOLLOW-UP QUESTIONS ──
  {
    ...
    context: "Frequent small check-ins build financial awareness without the overhead of formal budgeting.",
    expressPriority: "normal",
    options: [
      { value: "0", label: "0" },
      { value: "1", label: "1" },
