...
const FEATURE_LABELS = {
  ...
  basic_score: "Money Health Score",
  personality_type: "Your Money Style",
  emotional_triggers: "Money Moments Analysis",
  money_beliefs: "Deep Dive Into Money Beliefs",
  bias_analysis: "How You Think About Money",
  score_history: "Score Tracking & History",
  digital_twin_basic: "Money Future (1 scenario)",
  digital_twin_unlimited: "Money Future (Unlimited scenarios)",
  stress_testing: "Test Your Money Strength",
  banking_integration: "Connect Your Bank (Plaid)",
  ai_coach_basic: "Money Coach (Automated)",
  ai_coach_concierge: "Money Coach (One-on-One)",
  weekly_checkins: "Weekly Check-ins",
  action_follow_ups: "Week 1 & Month 1 Follow-ups",
  pdf_export: "Download Report as PDF",
