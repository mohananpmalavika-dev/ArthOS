...
export function getCohortStatistics() {
  ...
  if (stats.totalCohorts > 0) {
    ...
    stats.avgReturnsPerUser = (stats.totalReturns / stats.totalCohorts).toFixed(1);
  }
...
export function exportRetentionDataAsCSV() {
  ...
  let csv =
    "userId,enteredAt,assessmentCompleted,firstAssessmentDate,totalReturns,lastReturnDate\n";
