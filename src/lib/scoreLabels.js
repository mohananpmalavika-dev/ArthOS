...
export function getHealthBand(score) {
  return healthBandThresholds.find((band) => score <= band.max) || healthBandThresholds[healthBandThresholds.length - 1];
}
...
export function getSurvivalBand(months) {
  return survivalBandThresholds.find((band) => months <= band.max) || survivalBandThresholds[survivalBandThresholds.length - 1];
}
...
export function getBehaviourBand(score) {
  return behaviourBandThresholds.find((band) => score <= band.max)?.label || behaviourBandThresholds[behaviourBandThresholds.length - 1].label;
}
...
export function getAwarenessBand(score) {
  return awarenessBandThresholds.find((band) => score <= band.max)?.label || awarenessBandThresholds[awarenessBandThresholds.length - 1].label;
}
...
export function getStabilityBand(score) {
  return stabilityBandThresholds.find((band) => score <= band.max)?.label || stabilityBandThresholds[stabilityBandThresholds.length - 1].label;
}
